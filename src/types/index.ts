...
export type MacroTema = 'Inseguridad' | 'Economía' | 'Corrupción' | 'Social';
...
export interface Candidato {
  ...
  P11: number; P12: number; P13: number; P14: number; P15: number; P16: number;
}
...
export interface ResultadoCandidato {
  candidato: Omit<Candidato, 'P1'|'P2'|'P3'|'P4'|'P5'|'P6'|'P7'|'P8'|'P9'|'P10'|'P11'|'P12'|'P13'|'P14'|'P15'|'P16'>;
  afinidad: number;
}
